...
- Desktop page height under 9,000px. Currently **8,646px RO / 8,860px RU**
  on `main`, and **8,818px RO / 9,032px RU** on the unmerged wave 12 branches,
  against the R-J budgets of 8,850 and 9,100.
...
| Gate | Result |
|---|---|
| Homepage RO under 8,850px | **8,818px** ✓ |
| Homepage RU under 9,100px | **9,032px** ✓ |
