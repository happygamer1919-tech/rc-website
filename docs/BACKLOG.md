...
| W19-D1 | Long one-word headings overflow; the RU privacy page scrolls sideways | `w20/w19-d1-heading-overflow` | PR open, awaiting owner: headings hyphenate words of 14+ characters and break any that still cannot fit; 264 of 264 on the branch, `main` failed exactly the card's 6; 0 of 346 fitting headings changed line count; chosen over two measured alternatives; new gate 14 `check-heading-fit.js` in `quality`, 88 combinations, 5 failing arms and 1 passing arm with invented long words |
