...
## W27-FIX-13 · The owner's generated Acoperișuri picture on the service slot
**Status: PR OPEN** (opened 2026-09-23). Owner instruction W27-R-19: `svc-acoperisuri@2x_v2.jpg`
through `process-photos.js` onto the `svc-acoperisuri` slot (800x600 and 1600x1200, stripped);
renders on the homepage grid and the Acoperișuri hero, both locales. Provenance rows on W25-R3's
generated origin; the provenance gate learns the "n/a, generated by the owner" licence-URL form.

## W27-FIX-14 · Pictures appear at once, and the scroll stays smooth
**Status: PR OPEN** (opened 2026-09-23). Owner instruction W27-R-20: the reveal observer gains a
25% bottom margin (revealed before it scrolls into view, still once, no scroll handler); the
service cards, the step pictures and the roofing offer cards describe their pictures by width
with measured `sizes`, so a 2x screen takes the 1x file. Retina image bytes on the homepage
4,905KB to 2,905KB, roofing page 7,363KB to 6,927KB; no file re-encoded, JPEG only (W25-R2).

## W27-FIX-15 · Acoperișuri and Garduri in the Catalog
**Status: PR OPEN** (opened 2026-09-23). Owner instruction W27-R-21 (Mihai, urgent): the catalogue
lists termoizolație, Acoperișuri, Garduri, then the rest (`menu_position`); the roofing category's
page is a real page again carrying the service page's two bentos and nothing else (kind
...
**Status: MERGED #173, section 12.0 exit 0** (opened 2026-09-24). 110 fatade3d pictures looked at, 66 replaced by the
