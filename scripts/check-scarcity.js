...
const CODE = ['src/main.js', 'src/template.html', 'src/service.html', 'src/product.html', 'src/category.html', 'src/catalog-index.html', 'src/privacy.html', 'src/404.html', 'src/styles.css', 'build.js'];
