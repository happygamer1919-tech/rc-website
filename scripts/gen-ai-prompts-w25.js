...
L.push('');
L.push('## What W25-R9 removed from this pack');
L.push('');
L.push('The wave 25 pack used to carry 126 entries, 89 of them marked "appearance: not in the');
L.push('records": the 25 outdoor lamps and the 64 facade mouldings, which the data describes only');
L.push('by a shop code and a price. **W25-R9 forbids a generated image on any product card whose');
L.push('appearance is not in the records**, so they are gone from here and are listed as held at');
L.push('the foot. They wait on the client. Nothing in this pack is a guess at what a product');
L.push('looks like.');
L.push('');
