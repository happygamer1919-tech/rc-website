...
const PAGES = [
  ...
  { path: '/servicii/case-la-cheie/',      type: 'service-ba', label: 'svc RO case', budget: 6544 },
  { path: '/servicii/fatade/',             type: 'service', label: 'svc RO fatade',  budget: 5439 },
  { path: '/ru/servicii/case-la-cheie/',   type: 'service-ba', label: 'svc RU case', budget: 6676 },
  { path: '/ru/servicii/fatade/',          type: 'service', label: 'svc RU fatade',  budget: 5655 },
  ...
  { path: '/servicii/acoperisuri/',        type: 'service-roof', label: 'svc RO acoper', budget: 24357 },
  { path: '/ru/servicii/acoperisuri/',     type: 'service-roof', label: 'svc RU acoper', budget: 24578 },
  ...
  { path: '/servicii/tigla-metalica/',     type: 'tigla',   label: 'tigla RO',       budget: 4470 },
  { path: '/ru/servicii/tigla-metalica/',  type: 'tigla',   label: 'tigla RU',       budget: 4524 },
  ...
  { path: '/servicii/copertine/',          type: 'product', label: 'copertine RO',   budget: 7394 },
  { path: '/ru/servicii/copertine/',       type: 'product', label: 'copertine RU',   budget: 7471 },
  ...
  { path: '/servicii/garduri/',            type: 'product-hub', label: 'garduri RO',  budget: 5730 },
  { path: '/ru/servicii/garduri/',         type: 'product-hub', label: 'garduri RU',  budget: 5752 },
  ...
  { path: '/servicii/modele-garduri/',     type: 'product', label: 'gard modele RO', budget: 4452 },
  { path: '/ru/servicii/modele-garduri/',  type: 'product', label: 'gard modele RU', budget: 4474 },
  /* W26-12. The fence gallery page, measured 3967 in both locales; plus 60 (W24-R4). */
  { path: '/servicii/galerie-garduri/',    type: 'gallery', label: 'gal garduri RO', budget: 4101 },
  { path: '/ru/servicii/galerie-garduri/', type: 'gallery', label: 'gal garduri RU', budget: 4101 },
  ...
  { path: '/catalog/',                                      type: 'index',         label: 'idx RO',           budget: 3757 },
  { path: '/ru/catalog/',                                   type: 'index',         label: 'idx RU',           budget: 3782 },
  { path: '/catalog/termoizolatie/',                        type: 'category',      label: 'cat RO termo',     budget: 6939 },
  { path: '/ru/catalog/termoizolatie/',                     type: 'category',      label: 'cat RU termo',     budget: 6855 },
  { path: '/catalog/termoizolatie/polistiren-expandat/',    type: 'subcategory',   label: 'sub RO eps',       budget: 3682 },
  { path: '/ru/catalog/termoizolatie/polistiren-expandat/',  type: 'subcategory',   label: 'sub RU eps',       budget: 3599 },
  { path: '/catalog/termoizolatie/polistiren-extrudat/',    type: 'subcategory',   label: 'sub RO xps',       budget: 3159 },
  { path: '/ru/catalog/termoizolatie/polistiren-extrudat/',  type: 'subcategory',   label: 'sub RU xps',       budget: 3139 },
  { path: '/catalog/termoizolatie/vata-minerala/',          type: 'subcategory',   label: 'sub RO vata',      budget: 3641 },
  { path: '/ru/catalog/termoizolatie/vata-minerala/',       type: 'subcategory',   label: 'sub RU vata',      budget: 3642 },
  { path: '/catalog/termoizolatie/adezivi-si-mase-de-spaclu/',  type: 'subcategory',   label: 'sub RO adez',      budget: 4158 },
  { path: '/ru/catalog/termoizolatie/adezivi-si-mase-de-spaclu/',  type: 'subcategory',   label: 'sub RU adez',      budget: 4080 },
  { path: '/catalog/termoizolatie/alte-produse/',           type: 'subcategory',   label: 'sub RO altep',     budget: 3131 },
  { path: '/ru/catalog/termoizolatie/alte-produse/',        type: 'subcategory',   label: 'sub RU altep',     budget: 3090 },
  { path: '/catalog/tencuieli-decorative/',                 type: 'category',      label: 'cat RO tencu',     budget: 5387 },
  { path: '/ru/catalog/tencuieli-decorative/',              type: 'category',      label: 'cat RU tencu',     budget: 5464 },
  { path: '/catalog/placi-ceramice/',                       type: 'category',      label: 'cat RO placi',     budget: 12882 },
  { path: '/ru/catalog/placi-ceramice/',                    type: 'category',      label: 'cat RU placi',     budget: 13821 },
  { path: '/catalog/elemente-decorative/',                  type: 'category',      label: 'cat RO elem',      budget: 10274 },
  { path: '/ru/catalog/elemente-decorative/',               type: 'category',      label: 'cat RU elem',      budget: 10709 },
  { path: '/catalog/vopsele/',                              type: 'category',      label: 'cat RO vopsele',   budget: 4379 },
  { path: '/ru/catalog/vopsele/',                           type: 'category',      label: 'cat RU vopsele',   budget: 4475 },
  { path: '/catalog/vopsele/vopsele-de-exterior/',          type: 'subcategory',   label: 'sub RO vopext',    budget: 3139 },
  { path: '/ru/catalog/vopsele/vopsele-de-exterior/',       type: 'subcategory',   label: 'sub RU vopext',    budget: 3161 },
  { path: '/catalog/vopsele/vopsele-de-interior/',          type: 'subcategory',   label: 'sub RO vopint',    budget: 3161 },
  { path: '/ru/catalog/vopsele/vopsele-de-interior/',       type: 'subcategory',   label: 'sub RU vopint',    budget: 3207 },
  { path: '/catalog/sisteme-iluminare/',                    type: 'category',      label: 'cat RO ilumin',    budget: 6391 },
  { path: '/ru/catalog/sisteme-iluminare/',                 type: 'category',      label: 'cat RU ilumin',    budget: 6335 },
  { path: '/catalog/alte-materiale/',                       type: 'category',      label: 'cat RO alte',      budget: 3780 },
  { path: '/ru/catalog/alte-materiale/',                    type: 'category',      label: 'cat RU alte',      budget: 3780 },
